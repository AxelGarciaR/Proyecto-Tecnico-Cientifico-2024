...
CALL sp_insertar_usuario('ejemplo1@example.com', 'clave123', '123456789');
CALL sp_insertar_usuario('usuario2@example.com', 'password456', '987654321');
CALL sp_insertar_usuario('correo3@example.com', 'micontrasena', '654321987');
CALL sp_insertar_usuario('usuario4@example.com', 'secreto123', '111222333');
CALL sp_insertar_usuario('ejemplo5@example.com', 'password789', '444555666');
CALL sp_insertar_usuario('correo6@example.com', 'contrasena123', '777888999');
CALL sp_insertar_usuario('usuario7@example.com', 'clave456', '222333444');
CALL sp_insertar_usuario('correo8@example.com', 'mipassword', '555666777');
CALL sp_insertar_usuario('usuario9@example.com', 'contrasena789', '888999000');
CALL sp_insertar_usuario('ejemplo10@example.com', 'miclave', '123123123');
